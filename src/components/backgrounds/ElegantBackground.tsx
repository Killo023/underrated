  ...
  return (
    <div className={`fixed inset-0 -z-10 overflow-hidden ${className}`}>
      ...
      <motion.div
        ...
        style={{
          background: 'radial-gradient(circle at 30% 30%, rgba(0, 119, 230, 0.1), transparent 70%)'
        }}
        animate={{
          opacity: [0.2, 0.3, 0.2]
        }}
          ...
          <div
            ...
            style={{
              background: `radial-gradient(circle at 30% 30%, rgba(255,255,255,0.1), transparent 70%), 
                          linear-gradient(135deg, rgba(0, 119, 230, 0.1), rgba(0, 102, 204, 0.05))`
            }}
          />
        </motion.div>
      ))}
      ...
      {[...Array(6)].map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            background: `linear-gradient(90deg, transparent, rgba(0, 119, 230, 0.2), transparent)`
          }}
          animate={{
            x: [0, 300, -200, 0],
            y: [0, -100, 200, 0],
